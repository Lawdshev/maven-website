...
const blogPosts: BlogPost[] = [
  {
    ...
    content: "Artificial Intelligence is transforming the way we build applications...",
  ...
  },
  {
    ...
    content: "Web development continues to evolve with new frameworks and technologies...",
...
export async function createBlogPost(prevState: BlogFormState, formData: FormData): Promise<BlogFormState> {
...
export async function updateBlogPost(id: string, prevState: BlogFormState, formData: FormData): Promise<BlogFormState> {
  const isAuthenticated = await checkAuth()
  if (!isAuthenticated) {
    return {
      message: "Unauthorized",
