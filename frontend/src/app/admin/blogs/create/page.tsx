...
export default function CreateBlogPage() {
  ...
  return (
    <>
      <div className="space-y-6 text-footer-text max-w-[1780px] mx-auto">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Link
              href="/admin/blogs"
              className="text-[#0054aa] hover:text-[#003d7f] transition-colors"
            >
              <Button
                variant="outline"
            ...
            <div>
              <h1 className="text-3xl font-bold text-nav">
          ...
          <Card className="border-border shadow-sm">
            ...
            <CardContent className="space-y-4 p-4">
              ...
              <div>
                <Label
                  htmlFor="title"
                  className="text-sm xl:text-base mb-2 xl:mb-3 text-nav font-medium"
                >
                  Blog Title *
                </Label>
                <Controller
                  ...
                  render={({ field }) => (
                    <div className="flex flex-col gap-2">
                      ...
                      <Button
                        ...
                        type="button"
                        className="text-sm xl:text-base mb-2 xl:mb-3 self-start text-[#0054aa] hover:text-[#003d7f]"
                      >
                        + Add New Category
                      </Button>
                    </div>
