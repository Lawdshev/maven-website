...
const ReactQuill = dynamic(() => import("react-quill-new"), {
  ssr: false,
  loading: () => (
    <div className="h-64 bg-[#f8fafc] rounded-lg animate-pulse"></div>
  ),
});
...
export default function EditBlogPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex items-center space-x-2">
          <Loader2 className="h-6 w-6 animate-spin text-[#0054aa]" />
          <span className="text-footer-text">Loading blog post...</span>
        </div>
      </div>
    );
  }
  ...
  if (!blogPost) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-nav mb-4">
          Blog Post Not Found
        </h2>
        ...
        <Link href="/admin/blogs">
          <Button
            variant="outline"
            className="border-border hover:bg-[#f8fafc] hover:text-[#0054aa]"
          >
  ...
  return (
    <>
      <div className="space-y-6 text-footer-text max-w-[1780px] text-sm xl:text-base mx-auto">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-nav">Edit Blog Post</h1>
              <p className="text-footer-text mt-1">Update your blog article</p>
            </div>
          </div>
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          <Card className="border-border shadow-sm">
            ...
            <CardContent className="space-y-4 p-4">
              ...
              <div>
                <Label
                  className="mb-2 xl:mb-3 text-sm xl:text-base text-nav font-medium"
                  htmlFor="title"
                >
                  Blog Title *
                </Label>
                  ...
                  render={({ field }) => (
                    <div className="flex flex-col gap-2">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="mt-1 self-start text-[#0054aa] hover:text-[#003d7f]"
              ...
              <div>
                ...
                {blogPost.featuredImage && !watch("image") && (
                  <div className="mt-2">
                    <p className="text-sm text-footer-text mb-2">
                      Current image:
                    </p>
                    <img
