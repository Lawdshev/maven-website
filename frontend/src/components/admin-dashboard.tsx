  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-[medium]  text-black -900">
            ...
            {editState.message && (
              <p
                className={`text-center text-sm ${
                  editState.success ? "text-green-600" : "text-red-500"
                }`}
                aria-live="polite"
              >
                {editState.message}
      ...
      {showCreateForm && !editingPost && (
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          <h2 className="text-xl font-[medium]  text-black -900 mb-6">
          ...
          >
            ...
            <div>
              ...
              {createState.errors?.author && (
                <p className="text-red-500 text-xs mt-1">
                  {createState.errors.author.join(", ")}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {createState.errors?.excerpt && (
                <p className="text-red-500 text-xs mt-1">
                  {createState.errors.excerpt.join(", ")}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {createState.errors?.content && (
                <p className="text-red-500 text-xs mt-1">
                  {createState.errors.content.join(", ")}
                </p>
              )}
            </div>
            ...
            {createState.message && (
              <p
                className={`text-center text-sm ${
                  createState.success ? "text-green-600" : "text-red-500"
                }`}
                aria-live="polite"
              >
                {createState.message}
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          <h3 className="text-lg font-normal  text-black -900">
                            {post.title}
                          </h3>
                          <span
