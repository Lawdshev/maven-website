...
export default function AboutPage() {
  ...
  return (
    <div className="text-black mx-auto font-normal">
      {/* Hero */}
      <motion.main
        className="w-full max-h-[900px] h-[calc(100vh-100px)] relative text-white px-6 md:px-12 py-16 flex"
        initial="hidden"
        whileInView="show"
      ...
      >
        ...
        <div className="relative z-10 max-w-[1780px] w-[95%] mx-auto flex flex-col justify-between">
          <div className="text-left">
            ...
            <h1 className="text-5xl md:text-6xl xl:text-7xl lg:leading-[100px] mb-6 font-normal">
          ...
          <p className="text-xl text-white mb-8 leading-[35px] max-w-3xl">
      ...
      <motion.section
        ...
        variants={fadeUp}
      >
        <div className="max-w-[1780px] w-[95%] mx-auto flex flex-col gap-10">
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl md:text-4xl mb-6 text-[#0054aa] font-normal">
              Who We Are
            </h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 w-full">
            <motion.div
              variants={fadeUp}
              className="flex flex-col bg-white border border-gray-200 hover:bg-[#0054aa] hover:text-white transition-all duration-300"
            >
              <Image
              ...
              />
              <div className="p-6">
                <h3 className="text-2xl mb-3 font-normal">
                  Human + AI Together
                </h3>
                <p className="text-lg leading-[30px]">
                  We believe AI should empower people, not replace them. Our
                  mission is to combine human creativity with machine
                  intelligence to drive impact where it matters most.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-lg leading-[30px]">
                  From healthcare and finance to logistics and retail, we help
                  organizations apply AI responsibly and effectively to their
                  unique challenges.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              />
              <div className="p-6">
                <h3 className="text-2xl mb-3 font-normal">A True Partner</h3>
                <p className="text-lg leading-[30px]">
                  With transparency, collaboration, and experimentation at our
                  core, MavenCode is more than a service provider—we’re your
        ...
        <div className="max-w-[1780px] w-[95%] mx-auto flex flex-col gap-16">
          ...
          <div className="flex flex-col gap-20">
            {commitments.map((c, i) => (
              ...
              >
                <div className="p-8 bg-white border border-gray-200 hover:bg-[#0054aa] h-[350px] hover:text-white transition-all duration-300">
        ...
        <div className="max-w-[1780px] w-[95%] mx-auto flex flex-col gap-16">
          <motion.div variants={fadeUp}>
            ...
            <p className="text-xl leading-[35px] text-black max-w-3xl">
              ...
              partners. Collaboration, agility, and accountability define how we
              operate every day.
            </p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            {workingMethods.map((m, i) => (
              <motion.div
                key={i}
                className="group p-8 bg-white border border-gray-200 hover:bg-[#0054aa] hover:text-white transition-all duration-300 flex flex-col"
                variants={fadeUp}
              >
                <div className="w-12 h-12 flex items-center justify-center mb-4">
                  {/* icon receives the color + group-hover utility */}
                  <m.icon className="h-8 w-8 text-[#0054aa] transition-colors duration-300 group-hover:text-white" />
                </div>
            ...
            {principles.map((card, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-lg leading-[30px]">{card.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      {/* CTA */}
      <motion.div
        className="my-20 bg-white border border-gray-200 p-10 flex flex-col md:flex-row text-lg items-center justify-between hover:bg-[#0054aa] hover:text-white transition-all duration-500"
        initial="hidden"
        whileInView="show"
        viewport={{ once: true, amount: 0.2 }}
        variants={fadeUp}
      >
        <div className="mx-auto max-w-[1780px]">
          ...
          <Button
            variant="outline"
            className="bg-[#0054aa] hover:bg-white hover:text-[#0054aa] text-white text-xl rounded-none w-fit px-6 py-6 md:min-w-[200px] transition-all duration-300"
