        ...
        {!hasAnyContent ? (
          ...
          <div className="space-y-6">
            ...
            <div className="border-b border-gray-200 pb-4">
              ...
              {/* Blog Meta */}
              <div className="flex flex-wrap items-center gap-4 text-sm xl:text-base text-gray-600">
            ...
            <div className="border-t border-gray-200 pt-4">
              <div className="flex items-center justify-between text-sm xl:text-base text-gray-500">
