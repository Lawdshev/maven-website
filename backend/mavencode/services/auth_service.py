...
from mavencode.core.config import JWT_TOKEN_ALGORITHM
from mavencode.core.config import JWT_TOKEN_SECRET_KEY
from mavencode.models.users.token import TokenData
from mavencode.db.repositories.users.user import UserRepository
from mavencode.models.users.user import UserInDB, UserResponse
from mavencode.db.database import get_repository

oauth2_scheme = OAuth2PasswordBearer(tokenUrl=f"/auth/v1/mvc/users/login")
