...
export default function Approach() {
  return (
     <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
       <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row  gap-8 mb-20">
          ...
          <div className=" mt-4">
            <h3 className="text-4xl font-bold mb-4">Autonomous Operation</h3>
            <p className="text-base max-w-xl text-foreground/80 mb-4">
            ...
            <ul className="space-y-2">
              <li className="flex">
                <span className="text-blue-400 mr-2">•</span> Intelligent coding
                that adapt to demand.
              </li>
              <li className="flex">
                <span className="text-blue-400 mr-2">•</span> A common Decision
        ...
        <div className="flex flex-col lg:flex-row  gap-8">
          ...
          <div className=" mt-4">
            <h3 className="text-4xl font-bold mb-4">Co-Creation at the Core</h3>
            <p className="text-base max-w-xl text-foreground/80">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="mt-4">
            <h3 className="text-4xl font-bold mb-4">Seamless Integration</h3>
            <p className="text-base max-w-xl text-foreground/80">
