      ...
      <div className="max-w-6xl mx-auto py-36 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-4 text-left">
            <h1 className="text-4xl lg:text-6xl font-bold  text-about-text dark:text-about-text-dark leading-tight">
              About us
            </h1>
            
            <p className="text-base text-about-text dark:text-about-text-dark leading-relaxed max-w-sm">
            Welcome to <b>Mavencode</b>  — your trusted partner in AI and cloud transformation.We believe technology should deliver real impact, not hype. That’s why we design and scale intelligent solutions that are transparent, reliable, and built for the future. Whether it’s AI-driven automation, cloud-native systems, or enterprise integration, we help organizations unlock innovation and measurable value.
            </p>
