...
export default function AboutUsInfoBlocks() {
  return (
    <section className="bg-background dark:bg-background-dark relative">
      {/* Blue vertical lines */}
      ...
      <div className="max-w-6xl mx-auto py-20 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-1">
            ...
            <h3 className="text-xs text-about-heading dark:text-about-heading-dark mb-2">01</h3>
            <h4 className="text-sm font-medium text-about-heading dark:text-about-heading-dark mb-2">Our mission</h4>
          ...
          <div className="md:col-span-2">
            ...
            <h3 className="text-xs text-about-heading dark:text-about-heading-dark mb-2">02</h3>
            <h4 className="text-sm font-medium text-about-heading dark:text-about-heading-dark mb-2">Who we serve</h4>
            <p className="text-xs text-about-text dark:text-about-text-dark max-w-xs ">
          ...
          <div className="md:col-span-2">
            ...
            <h3 className="text-xs text-about-heading dark:text-about-heading-dark mb-2">03</h3>
            <h4 className="text-sm font-medium text-about-heading dark:text-about-heading-dark mb-2">Goals</h4>
            <p className="text-xs text-about-text dark:text-about-text-dark max-w-xs">
          ...
          <div className="md:col-span-1">
            ...
            <h3 className="text-xs  text-about-heading dark:text-about-heading-dark mb-2">04</h3>
            <h4 className="text-sm font-medium text-about-heading dark:text-about-heading-dark mb-2">Why Mavencode?</h4>
            <p className="text-xs text-about-text dark:text-about-text-dark max-w-xs">
